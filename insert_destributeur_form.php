<?php require_once("medicaments.php"); 
...
<title>insert destributeur</title>
...
<form action="insert_destributeur_form_action.php" method="post">
<h1>Ajout d'une nouvelle destributeur</h1>
  <div class="form-group">
    <label for="nom">Nom du destributeur</label>
